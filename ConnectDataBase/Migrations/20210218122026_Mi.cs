        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Performance_id = table.Column<int>(type: "int", nullable: false),
                    Employer_id = table.Column<int>(type: "int", nullable: false),
                    Employer_type_of_work_id = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Heliak", "Mikolaj", new DateTime(2021, 2, 18, 13, 20, 26, 365, DateTimeKind.Local).AddTicks(6832), "123", "menager" });
